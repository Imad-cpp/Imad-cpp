...
They may know how to run `git add` or `git commit`, but still struggle with questions such as:

- How should I structure a university project repository?
- What belongs in a README?
- How do branches and pull requests fit together?
- What should I do when Git goes wrong?
...
A guide should lead to something the student can verify, for example:

- a working local Git repository;
...
That means the project has to consider:

- terminology consistency;
- RTL readability;
- code mixed with Arabic text;
...
- clear guides and templates;
- explicit curriculum order;
- content/trust rules;
...
The Dev Kit therefore treats these as first-class rules:

- no real student numbers, phone numbers or private addresses in examples;
- no tokens or credentials;
- no copied protected course material without compatible permission;
...
- Git/GitHub teaching through real workflow;
- privacy-aware examples;
- content governance; and
- building documentation repositories that are maintainable like software projects.

## Public context

- [N9raw GitHub organization](https://github.com/N9RAW)

The Dev Kit should only be linked directly from the public profile when its repository is intentionally public and ready to maintain.

---

[Next case study: Nexar →](nexar.md)
